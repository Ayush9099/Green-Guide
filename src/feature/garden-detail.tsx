                ...
                <div className="bg-white shadow-md rounded-lg p-6">
                    {isEditing ? (
                        <form className="space-y-4">
                            ...
                            <div>
                                <label htmlFor="plants" className="block text-sm font-medium text-gray-700">Plants</label>
                                <select
                                    multiple
                                    id="plants"
                            ...
                            <div>
                                <label htmlFor="last_watered" className="block text-sm font-medium text-gray-700">Last Watered</label>
                                <input
                                    type="date"
                                    id="last_watered"
                            ...
                            <div>
                                <label htmlFor="fertilized_schedule" className="block text-sm font-medium text-gray-700">Fertilization Schedule</label>
                                <select
                            ...
                            <div>
                                <label htmlFor="growth_notes" className="block text-sm font-medium text-gray-700">Growth Notes</label>
                                <textarea
                                    id="growth_notes"
